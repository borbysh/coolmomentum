""" This is a modified version of 
    https://github.com/ifeherva/optimizer-benchmark/blob/master/train_cifar10.py   """
...
def parse_args(argv=None):
    ...
    parser.add_argument('--model', default='resnet34', type=str, help='model',
                        choices=['resnet34'])
    parser.add_argument('--optim', type=str, default='coolmomentum', help='optimizer', required=True,
...
def train_cifar10(opt, optimizer_opts):
    ...
    print('[epochs: {}, batch size: {}, learning rate: {}]'.format(opt.epochs, 128, 0.01), "\r", file=fout )
    print('e: {}, train loss: {}, train accuracy: {}, test accuracy: {}', "\r", file=fout )
    fout.close() #create and close a new log file
    ...
    for epoch in range(opt.epochs):
        ...
        print(epoch, train_loss, train_acc, test_acc, "\r", file=fout )
