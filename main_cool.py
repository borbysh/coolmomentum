...
import utils_cool as utils #cool
...
def model_fn(features, labels, mode, params):
  ...
  if is_training:
    ...
    scaled_lr = FLAGS.base_learning_rate #* (FLAGS.train_batch_size / 256.0)  #cool
    ...
    optimizer = utils.build_optimizer(learning_rate,
                                      global_step, #cool
                                      total_steps=FLAGS.train_steps, steps_per_epoch=params['steps_per_epoch']) #cool
    if FLAGS.use_tpu:
